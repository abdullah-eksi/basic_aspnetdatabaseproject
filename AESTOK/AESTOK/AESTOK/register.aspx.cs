...
namespace AESTOK.AESTOK
{
    public partial class register : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                komut = new SqlCommand("insert into uye values(@kullaniciadi, @uye_mail, @uye_password)", baglanti);
                komut.Parameters.AddWithValue("@kullaniciadi", TextBox1.Text);
                komut.Parameters.AddWithValue("@uye_mail", TextBox2.Text);
                komut.Parameters.AddWithValue("@uye_password", TextBox3.Text);
            ...
            {
               Response.Write( "Hata oluştu, kaydedilemedi. Hata Kodu: " + ex.Message);
            }
            finally
            {
                baglanti.Close();
