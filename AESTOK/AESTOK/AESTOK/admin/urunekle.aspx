<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="urunekle.aspx.cs" Inherits="AESTOK.AESTOK.admin.urunekle" %>
  ...
  <body>
    <header class="header">   
      ...
      <!-- Sidebar Navigation end-->
        ...
        <div class="form-group">
            <form runat="server">
                        <label class="form-control-label">URUN ADI</label>
             ...
             <div class="form-group">       
                          <label class="form-control-label">&nbsp;URUN FİYAT</label>
