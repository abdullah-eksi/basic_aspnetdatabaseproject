<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="musteriupdate.aspx.cs" Inherits="AESTOK.AESTOK.admin.musteriupdate" %>
...
<section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong class="d-block">MÜSTERİ GÜNCELLE</strong><span class="d-block"></span></div>
                  <div class="block-body">
                    <form runat="server">
                      <div class="form-group">
                        <label class="form-control-label">MUSTERİ AD</label>
                       <asp:TextBox  class="form-control" ID="TextBox3" runat="server"></asp:TextBox>
                      </div>
                          <div class="form-group">
                        <label class="form-control-label">MUSTERİ YAS</label>
                         <asp:TextBox  class="form-control" ID="TextBox2" runat="server"></asp:TextBox>
                      </div>
                      <div class="form-group">       
                        <label class="form-control-label">MUSTERİ TEL</label>
                        <asp:TextBox  class="form-control" ID="TextBox1" runat="server"></asp:TextBox>
                      </div>
                           <div class="form-group">       
                        <label class="form-control-label">MUSTERİ ADRES</label>
                        <asp:TextBox  class="form-control" ID="TextBox5" runat="server"></asp:TextBox>
                      </div>
                      <div class="form-group">       
                        <asp:TextBox  class="form-control" ID="TextBox4" runat="server" Visible="False"></asp:TextBox>
                      </div>
                        <div class="form-group">  
