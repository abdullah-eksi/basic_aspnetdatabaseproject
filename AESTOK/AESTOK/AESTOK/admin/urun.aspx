<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="urun.aspx.cs" Inherits="AESTOK.AESTOK.admin.urun" %>
    ...
    <header class="header">   
      ...
      <div class="page-content">
       ...
       <div class="col-lg-12">
                <div class="block">
                     <div align="right">
              <a href="urunekle.aspx"  class="btn btn-info">EKLE</a>
                  </div>
                    ...
                    <table class="table table-striped table-sm">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><%#Eval("urunmarka").ToString()%></td>    
                            <td><%#Eval("urunkodu").ToString()%></td> 
                            <td><%#Eval("urunfıyat").ToString()%></td> 
                            <td><%#Eval("urunadet").ToString()%></td> 
                            <td><%#Eval("urundetay").ToString()%></td> 
                           
                            <td>
                                <asp:HyperLink class="btn-btn-danger" ID="HyperLink2" runat="server" NavigateUrl='<%# string.Format("usil.aspx?Id={0}",

                HttpUtility.UrlEncode(Eval("Id").ToString())) %>'

            Text="KALDIR" /> 
                                
                                  <asp:HyperLink class="btn-btn-success" ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("urunguncelle.aspx?Id={0}",
