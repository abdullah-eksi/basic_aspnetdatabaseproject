<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sosyalayar.aspx.cs" Inherits="AESTOK.AESTOK.admin.sosyalayar" %>
...
<section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong class="d-block">SOSYAL MEDYA AYARLAR</strong><span class="d-block">ayarları aşağıdan değişebilirsiniz</span></div>
                  <div class="block-body">
                      <form id="form1" runat="server">
                      <div class="form-group">
                        <label class="form-control-label"><i style="color: blueviolet" class="fa fa-instagram"></i> İNSTANGRAM URL
                          </label>
                      
                      </div>
                          <asp:TextBox ID="TextBox1" placeholder="instaurl" runat="server" class="form-control">   </asp:TextBox>
                          <div class="form-group">
                        <label class="form-control-label"> <i style="color:red"class="fa fa-youtube"></i> YOUTUBE URL</label>
                        <asp:TextBox ID="TextBox2" placeholder="yturl" runat="server" class="form-control">   </asp:TextBox>
                      </div>
                      <div class="form-group">       
                        <label class="form-control-label"><i style="color:aqua" class="fa fa-twitter"></i> TWİTTER URL</label>
                        <asp:TextBox ID="TextBox3" placeholder="twitterurl" runat="server" class="form-control">   </asp:TextBox>
                      </div>
                            <div class="form-group">       
                        <label class="form-control-label"> <i style="color:burlywood" class="fa fa-google"></i> GOOGLE URL</label>
                        <asp:TextBox ID="TextBox4" placeholder="googleurl" runat="server" class="form-control">   </asp:TextBox>
                      </div>
