<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="musteriekle.aspx.cs" Inherits="AESTOK.AESTOK.admin.musteriekle" %>
              ...
              <div class="col-lg-12">
                <div class="block">
                  ...
                  <div class="block-body">
                      ...
                      <div class="form-group">
                        <label class="form-control-label">MÜŞTERİ ADI</label>
                      <asp:TextBox ID="TextBox1" runat="server" class="form-control"></asp:TextBox>
                      </div>
                          <div class="form-group">
                        <label class="form-control-label">MÜŞTERİ YAŞ</label>
                         <asp:TextBox ID="TextBox2" runat="server" class="form-control"></asp:TextBox>
                      </div>
                      <div class="form-group">       
                        <label class="form-control-label">MÜŞTERİ TEL</label>
                         <asp:TextBox ID="TextBox3" runat="server" class="form-control"></asp:TextBox>
                      </div>
                           <div class="form-group">       
                        <label class="form-control-label">MÜŞTERİ ADRES</label>
                         <asp:TextBox ID="TextBox4" runat="server" class="form-control"></asp:TextBox>
                               <asp:TextBox ID="TextBox5" runat="server" class="form-control" Visible="False"></asp:TextBox>
                      </div>
                    <asp:Label ID="Label3" runat="server" Text=""></asp:Label>
                      <div class="form-group">       
                        <asp:Button ID="Button1" runat="server" class="btn btn-primary" Text="EKLE" OnClick="Button1_Click1" />
